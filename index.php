        ...
        <form action="" class="delivery">
            <fieldset>
                ...
                <div>
                    ...
                    <input type="text" placeholder="E.g. 33_Nguyen Van Khiem">
                    <label for="">Phone Number</label>
                    <input type="text" placeholder="E.g. +113...">
                    <label for="">Email</label>
                    <input type="text" placeholder="E.g. khiem22072001@gmail.com">
                    <label for="">Address</label>
                    <textarea name="" id="" cols="30" rows="10" placeholder="E.g. Tây Sơn, Đống Đa"></textarea>
